...
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("Deveria devolver código http 20 quando as informações estão validas")
    @WithMockUser
    void agendarCenario2() throws Exception {
        var data = LocalDateTime.now().plusHours(1);
        var especialidade = Especialidade.CARDIOLOGIA;

        when(agenda.agendar(any())).thenReturn(new DadosDetalhamentoConsulta(null, 2l, 5l, data));
